...
#endif
@implementation PhoenixPortService
+ (void)initialize
{
	[[USGlobals sharedInstance].wsdlStandardNamespaces setObject:@"xs" forKey:@"http://www.w3.org/2001/XMLSchema"];
	[[USGlobals sharedInstance].wsdlStandardNamespaces setObject:@"PhoenixPortService" forKey:@"http://phoenix.com/hr/definitions"];
...
{
	return [[PhoenixPortSoap11Binding alloc] initWithAddress:@"https://89.29.122.60:18442/phoenix/phoenixService/phoenix.wsdl"];
}
@end
